...
object CTC {
  ...
  def createCourse()(using cc:CallClient):Ref[Course] =
    (for
      case StandardReturn.ReturnWithPermissions(ReturnCourse(c), perms) <- cc.call(CourseCall.CreateCourse(Course(
        ...
        shortName = Some("COSC370/570 2025"),
  ...
  def getCourse()(using cc:CallClient):RefOpt[Course] = (for case ReturnCourse(c) <- cc.call(CourseCall.ByShortName("COSC370/570 2025")) yield c)
